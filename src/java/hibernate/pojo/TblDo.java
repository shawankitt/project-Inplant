...
public class TblDo  implements java.io.Serializable {
    ...
    public TblDo(BigDecimal IDoId, TblPlant tblPlant, Date dtIssueDate, String TConsignee, String TConsigner, String TDeliveryAddress, Date dtIssueTime, Set<TblMapping> tblMappings) {
       this.IDoId = IDoId;
       this.tblPlant = tblPlant;
