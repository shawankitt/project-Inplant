...
public class TblTransporter  implements java.io.Serializable {
    ...
    public TblTransporter(BigDecimal ITransporterId, TblPlant tblPlant, String TTransporterName, String TTransporterMobileNo, String TTransporterAddr, String TTransporterCity, String TTransporterState, String ITransporterPin, String TTransporterEmailId, Set<TblVehicle> tblVehicles, Set<TblMapping> tblMappings, Set<TblDriver> tblDrivers) {
       this.ITransporterId = ITransporterId;
       this.tblPlant = tblPlant;
