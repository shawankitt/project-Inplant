...
// Generated 6 Jun, 2015 9:41:05 PM by Hibernate Tools 4.3.1
...
public class TblUsers  implements java.io.Serializable {
    ...
    public TblUsers(String SUsername, TblPlant tblPlant, String SPassword, String SPasswordMd5, Boolean BRemoveTrip, Boolean BViewTrip, Boolean BNodeView, Boolean BAddTrip, Boolean BViewException, Boolean BEndException, Boolean BViewHistory, Boolean BSetupNewPlant, Boolean BPlantModify, Boolean BAddUser, Boolean BModifyUser, Boolean BChangeCurrentPlant, Boolean BAddVehicle, Boolean BModifyVehicle, Boolean BModifyDriver, Boolean BAddDriver, Boolean BViewDo, Boolean BLoggedIn, BigDecimal ITransporterId, BigDecimal IDriverId, Boolean BModifyTransporter, Boolean BAddTransporter, Boolean BAddCard, Boolean BModifyLink, Boolean BAddLink, Boolean BModifyProcess, Boolean BAddProcess, Boolean BModifyEpos, Boolean BAddEpos, Boolean BModifyPath, Boolean BAddPath, Boolean BModifyCard) {
       this.SUsername = SUsername;
       this.tblPlant = tblPlant;
    ...
    public Boolean getBModifyTransporter() {
        return this.BModifyTransporter;
    }
